class PizzaDelivery:
    ...
    def update_pizza_price(self, ingredient_price):
    ...
    def add_extra(self, ingredient: str, quantity: int, ingredient_price: float):
        ...
        if ingredient in self.ingredients:
            ...
            self.update_pizza_price(ingredient_price)
            return
        self.ingredients[ingredient] = quantity
        self.update_pizza_price(ingredient_price)
    ...
    def make_order(self):
        self.ordered = True
        pizza = [f"{ingredients}: {quantities}"for ingredients, quantities in self.ingredients.items()]
